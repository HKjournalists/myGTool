...
//	private static String from = "enfodesk_isu@sina.cn";
	private static String from = "myeoss@analysys.com.cn";
	// 收件人
...
//		attachmentPart.setFileName(fds.getName());
	...
	/**发送带附件的邮件
	 * @throws Exception */
	public void sendExaMail(String extra, String receiver, String cc) throws Exception {
		...
		message.setSubject("西门子渠道价格巡检报告");//主题
...
//		MimeBodyPart attachment02 = createAttachment("D:\\javamail\\进度.txt");
		MimeBodyPart content = createContent("<h4>"+"尊敬的用户：<br />  您好！<br />巡检程序出现异常！"+"</h4>");
		//---------------添加附件，正文内容-------end-------------------------
...
//		allPart.addBodyPart(attachment02);
		...
		transport.connect("myeoss", "m3638eoss");//用户名，密码
		try {
	...
	public static void main(String[] args) throws Exception {
		OZBuildMail m = new OZBuildMail();
		m.sendExaMail("d:/1.xls,d:/2.xls,", "ouzhou@analysys.com.cn,ouzhou@analysys.com.cn,", "");
//		m.sendSimpleMail();
//		m.sendExaMail();
